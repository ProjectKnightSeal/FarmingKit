...
public class GridPropertiesManager : SingletonMonobehaviour<GridPropertiesManager>, ISaveable
{
    ...
    private void ConnectDugGround(GridPropertyDetails gridPropertyDetails)
    {
        ...
        //Set 4 tiles if dug surrounding current tile - up, down, left, right now that this central tile has beed dug
    ...
    {
        //Get whether surrounding tiles (ui,down,left,and right) are dug or not
    ...
    private void InitialiseGridProperties()
    {
        ...
        foreach(SO_GridProperties so_GridProperties in so_gridPropertiesArray)
        {
            ...
            //Populate grid property dictionary - Iteate through all the grid properties in the so gridproperties list
            ...
            //Add grid proprerty dictionary to scene save data
    ...
    ///grid property detailsvalues are null or false
    ...
    public void ISaveableRestoreScene(string sceneName)
    {
        ...
        {
            //get grid property details dictionary - it exists we created it in initialise
            if (sceneSave.gridPropertyDetailsDictionary != null)
            {
                gridPropertyDictionary = sceneSave.gridPropertyDetailsDictionary;
            }

            //get dictioary of bools - if exists since we created it in initialise
            ...
            if (gridPropertyDictionary.Count > 0)
            {
                ...
                //Instantiate grid groperty details for current scene
    ...
    public void ISaveableStoreScene(string sceneName)
    {
        ...
        //create & add dict dictionary for first time scene loaded
        sceneSave.boolDictionary = new Dictionary<string, bool>();
