...
public class UIInventoryBar : MonoBehaviour
{
    ...
    //Clear all highlights from the inventory ber
    ...
    private void SwitchInventoryBarPosition()
    {
        ...
        {
            //transform.position = new Vector3(transform.position.x, 7.5f, 0f); // this was changed to control the recttransform see helow
