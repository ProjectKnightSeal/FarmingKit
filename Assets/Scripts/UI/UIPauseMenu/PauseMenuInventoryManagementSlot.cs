...
public class PauseMenuInventoryManagementSlot : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        //move game object as draggeditem
        if (draggedItem != null)
        {
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (draggedItem != null)
        {
            ...
            if (eventData.pointerCurrentRaycast.gameObject != null && eventData.pointerCurrentRaycast.gameObject.GetComponent<PauseMenuInventoryManagementSlot>() !=
                null)
            {
