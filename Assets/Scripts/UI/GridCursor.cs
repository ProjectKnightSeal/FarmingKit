...
public class GridCursor : MonoBehaviour
{
    ...
    private void SetCursorValidity(Vector3Int cursorGridPosition,Vector3Int playerGridPosition)
    {
        ...
        {
            //Detarmine cursor validity based on inventory item selected and grid property details
    ...
    //Test cursor validity for a cummodity for target gridPropertyDetails. Returns true if valid, false if invalid
    private bool IsCursorValidForCommodity(GridPropertyDetails gridPropertyDetails)
    {
        return gridPropertyDetails.canDropItem;
    }

    //Set cursor validity for a seed for the target gridPropertyDetails. Returns true valid, false if invalid
    private bool IsCursorValidForSeed(GridPropertyDetails gridPropertyDetails)
    {
        return gridPropertyDetails.canDropItem;
    }

    //Set the cursor as either valid or invalid for the tool for the target gridPropertyDetails. Returns true if valid or false if invalid
