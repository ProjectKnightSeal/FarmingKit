...
public class CropDetails
{
    ...
    public bool disableCropCollidersBeforeHarvestedAnimation;//if colliders on crop should be disabled to avoid the harvested animation effectiong any other game object
    ...
    public int[] requiredHarvestActions;//number of harvest actions required for corressponding tool in havest tool item code array
    [ItemCodeDescription]
    ...
    public int[] cropProducedMaxQuantity;//if max quantity is > min quantity then a random numder of crops between min and max
