...
public class AudioManager : SingletonMonobehaviour<AudioManager>
{
    ...
    private void PlayMusicSoundClip(SoundItem musicSoundItemm,float transitionTimeSeconds)
    {
        //Set Volume
        gameAudioMixer.SetFloat("MusicVolume", ConvertSoundVolumeDecimalFractionToDecibels(musicSoundItemm.soundVolume));

        //Set clip & play
        gameMusicAudioSource.clip = musicSoundItemm.soundClip;
